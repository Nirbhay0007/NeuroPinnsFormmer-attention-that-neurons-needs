# ==============================================================================
# Model M5: Static Weight PINNsFormer Architecture (-NTK Ablation)
# Disables Dynamic NTK Gradient Balancing Loop; Uses Fixed λ_i = 1.0
# ==============================================================================
include("../architectures.jl")
include("../loss_and_optimization.jl")
include("../benchmark_runner.jl")

println("=== Model M5: Static Weight PINNsFormer (-NTK) ===")
...
println("Parameter Count: ", count_parameters(model_m5))

# Note: use_ntk=false disables the dynamic weight updater loop
trained_m5, wall_time = train_model_single_run(model_m5, dataloader; adam_epochs=1000, lbfgs_epochs=200, use_ntk=false)
metrics = evaluate_relative_l2_error(trained_m5, HH_data)
