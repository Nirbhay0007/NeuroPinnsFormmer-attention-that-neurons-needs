# ==============================================================================
# Model M4: SIREN-PINNsFormer Architecture (Sinusoidal Frequency Variant)
# Replaces Wavelets with Sinusoidal Periodic Activation Functions sin(30*x)
# ==============================================================================
include("../architectures.jl")
include("../loss_and_optimization.jl")
include("../benchmark_runner.jl")

println("=== Model M4: SIREN-PINNsFormer ===")
