...
# Replaces Localized Wavelets with Global Continuous tanh Activation
# ==============================================================================
include("../architectures.jl")
include("../loss_and_optimization.jl")
include("../benchmark_runner.jl")

println("=== Model M2: tanh-PINNsFormer ===")
...
metrics = evaluate_relative_l2_error(trained_m2, HH_data)
