# ==============================================================================
# Model M-Wang: Modified Gated PINN Architecture (Wang et al., 2021)
# Twin Forward Encoders + Multiplicative Gating to Prevent Gradient Pathologies
# ==============================================================================
include("../architectures.jl")
include("../loss_and_optimization.jl")
include("../benchmark_runner.jl")

println("=== Model M-Wang: Modified Gated PINN Baseline ===")
