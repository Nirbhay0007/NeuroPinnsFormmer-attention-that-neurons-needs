# ==============================================================================
# SYSTEM B: Activation & Spectral Benchmark Execution Script
...
println("Running M2, M3, M4, M-MLP, M-SIREN, M-Wang across 3 random seeds...")
println("=========================================================================\n")
...
println("\n[SYSTEM B COMPLETE] Results saved to $output_path")
